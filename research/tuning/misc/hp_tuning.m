...
path_misc = fileparts(current_path);
path_tuning = fileparts(path_misc);
path_research = fileparts(path_tuning);
path_root = fileparts(path_research);
path_tests = fullfile(path_root, "tests");
...
path_testdata = fullfile(path_tuning, "tuning_data");
...
path_testdata = fullfile(path_tuning, "tuning_data");
path_testdata_outdir = fullfile(path_testdata, tst);
