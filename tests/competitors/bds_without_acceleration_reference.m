function [xopt, fopt, exitflag, output] = bds_without_acceleration_reference(fun, x0, options)
...
options = set_bds_without_acceleration_reference_options(options, n, x0);
